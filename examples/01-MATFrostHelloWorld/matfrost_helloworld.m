...
mjl.MATFrostHelloWorld.matfrost_sum((1:100)')
    % = 5050
%% Ex3: Polynomial multiplication
mjl.MATFrostHelloWorld.matfrost_polynomial_quadratic_multiplication( ...
...
mjl.MATFrostHelloWorld.total_population(country) % 920+565+246 = 1731
%% Ex5: Multi-dispatch example
% Call with integers
result_int = mjl.MATFrostHelloWorld.matfrost_multi_dispatch("x::Int, y::Int",10, 20)
    % = 30
% Call with strings
result_str = mjl.MATFrostHelloWorld.matfrost_multi_dispatch("x::String, y::String","Hello ", "World")
    % = "Hello World"