...
"""
Convert a Julia value before MATFrost serializes it for MATLAB.

The default implementation returns the value unchanged. External packages
can add more specific methods for domain-specific Julia types.
"""
